<?php
	...
	if (!isset($userInfo['userPermissions']['tools']['AGENTDOCUMENTATION']) || $getGUID == "") {
		...
		echo "		permissions required: AGENTDOCUMENTATION: [ADD], [EDIT], [ALL]<br />\n";
	...
	$sql = "SELECT * FROM lookupSupervisorInfo LEFT JOIN lookupPermissions ON lookupSupervisorInfo.GUID=lookupPermissions.GUID WHERE lookupPermissions.GUID IS NOT NULL AND supervisorStatus ='ACTIVE' ORDER BY lastName, firstName ASC";
